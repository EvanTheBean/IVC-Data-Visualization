...
public class LogInAuthenticator : MonoBehaviour
{
    ...
    public async void SignIn() //Signs in the player with a new anonymous id
    {
        ...
        catch
        {
            ...
            DebugCanvas.Instance.Log("LIAuth: Failed to login.");
            throw;
        }
    }
    ...
    {
        DebugCanvas.Instance.Log("LIAuth: Signed in successfully.");
    }

    private void OnSignOut()
    {
        DebugCanvas.Instance.Log("LIAuth: Signed out successfully.");
    }
}
